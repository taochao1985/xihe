 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_title">
      ...
      <a class="btn btn-success navbar-right btn-xs" href="/admin/lessions/create">新增</a>
    ...
    <div class="x_content">
      <table id="datatable-fixed-header" class="table table-striped table-bordered">
        ...
        <tbody>
          <?php  if($lessions){ foreach ($lessions as $key=>$val){?>
                <tr>
    ...
    <script src="/assets/js/admin/lession_index.js"></script>
<script>
